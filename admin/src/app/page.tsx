            ...
            {[
              ...
              <Reveal key={i} delay={i * 0.1}>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-primary leading-snug">{lawyer.name}</h3>
                  <p className="text-secondary font-medium uppercase text-xs tracking-wider mt-1">{lawyer.role}</p>
                </motion.div>
              </Reveal>
            ))}
          </div>
